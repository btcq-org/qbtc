...
test-unit:
	...
	@go test -mod=readonly -v -short -timeout 30m ./...
...
test-zk:
	...
	@go test -mod=readonly -v -timeout 30m -tags=testing ./x/qbtc/zk/...
...
.PHONY: test test-all test-unit test-race test-cover bench
