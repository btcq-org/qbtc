...
func (*MsgEmpty) Descriptor() ([]byte, []int) {
	return fileDescriptor_54fcd58db82d446b, []int{0}
}
...
func init() {
	proto.RegisterType((*MsgEmpty)(nil), "btcq.btcq.v1.MsgEmpty")
}

func init() { proto.RegisterFile("btcq/btcq/v1/tx.proto", fileDescriptor_54fcd58db82d446b) }

var fileDescriptor_54fcd58db82d446b = []byte{
	// 228 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x12, 0x4d, 0x2a, 0x49, 0x2e,
	...
	0xa4, 0xe7, 0xa7, 0xe7, 0x43, 0xc4, 0x41, 0x2c, 0xa8, 0xa8, 0x0c, 0x8a, 0x0b, 0x72, 0x8b, 0xd3,
	0xe3, 0x73, 0x33, 0x73, 0x33, 0x8b, 0x20, 0xb2, 0x4a, 0x5c, 0x5c, 0x1c, 0xbe, 0xc5, 0xe9, 0xae,
	0xb9, 0x05, 0x25, 0x95, 0x46, 0xae, 0x5c, 0xcc, 0xbe, 0xc5, 0xe9, 0x42, 0xe6, 0x5c, 0xac, 0xbe,
	0x20, 0x15, 0x42, 0x62, 0x7a, 0xc8, 0xae, 0xd4, 0xf3, 0x2d, 0x4e, 0x07, 0x8b, 0x4b, 0x61, 0x8a,
	0x83, 0xf5, 0x4b, 0xb1, 0x36, 0x3c, 0xdf, 0xa0, 0xc5, 0xe8, 0x64, 0x7f, 0xe2, 0x91, 0x1c, 0xe3,
	...
	0xb9, 0x60, 0x07, 0xe9, 0xe6, 0x17, 0xa5, 0x43, 0x5c, 0x56, 0x01, 0xa1, 0x4a, 0x2a, 0x0b, 0x52,
	0x8b, 0x93, 0xd8, 0xc0, 0x4e, 0x33, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0xab, 0x1a, 0x25, 0x3c,
	0x3c, 0x01, 0x00, 0x00,
}
...
func (c *msgClient) Mimir(ctx context.Context, in *MsgMimir, opts ...grpc.CallOption) (*MsgEmpty, error) {
	out := new(MsgEmpty)
	err := c.cc.Invoke(ctx, "/btcq.btcq.v1.Msg/Mimir", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_Mimir_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/btcq.btcq.v1.Msg/Mimir",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "btcq/btcq/v1/tx.proto",
}
