...
func NewKeeper(
	...
	k := &Keeper{
		...
		LPs: collections.NewMap(sb, types.LPsPrefix, "liquidity_providers",
			collections.StringKey, codec.CollValue[types.LiquidityProvider](cdc)),
		Bonds: collections.NewMap(sb, types.BondsPrefix, "bonds",
			collections.StringKey, codec.CollValue[types.Bond](cdc)),
		PendingAdds: collections.NewMap(sb, types.PendingAddsPrefix, "pending_adds",
			collections.Uint64Key, codec.CollValue[types.PendingAdd](cdc)),
		PendingAddSeq: collections.NewSequence(sb, types.PendingAddSeqKey, "pending_add_seq"),
		PendingAddByNode: collections.NewMap(sb, types.PendingAddByNodeKey,
			"pending_add_by_node",
			collections.StringKey, collections.Uint64Value),
		ConstOverrides: collections.NewMap(sb, types.ConstOverridesKey,
			"const_overrides",
